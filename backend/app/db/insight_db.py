...
ALTER TABLE users ADD COLUMN IF NOT EXISTS cost_alert_2usd_sent BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE users ADD COLUMN IF NOT EXISTS cost_alert_sent_date TEXT NOT NULL DEFAULT '';
...
class InsightDB:
    ...
    def initialize(self):
        ...
        try:
            ...
            self._pool = ConnectionPool(dsn, min_size=1, max_size=10, open=True, check=lambda conn: conn.execute("SELECT 1"))
