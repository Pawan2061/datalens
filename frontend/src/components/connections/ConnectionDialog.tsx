...
const CONNECTOR_TYPES: { type: ConnectorType; label: string; desc: string; cssClass: string }[] = [
  ...
  { type: 'powerbi', label: 'Power BI', desc: 'Microsoft Power BI', cssClass: 'cd-type-icon--powerbi' },
...
export default function ConnectionDialog({
  ...
  return (
    <div className="cd-overlay">
      <div className="cd-dialog" style={{ maxWidth: 600 }}>
        {/* Header */}
        <div className="cd-header">
          <div className="cd-header-left">
            <Database size={20} color="#0052a3" />
          ...
          {step === 'choose-type' && (
            <>
              {connections.length > 0 && (
                <div className="cd-saved" style={{ marginBottom: 16 }}>
                  <p className="cd-section-label">Saved Connections</p>
                  {connections.map((conn) => (
                    <button
                      key={conn.id}
                      onClick={() => { onSelectConnection(conn.id); handleClose(); }}
                      className={`cd-saved-item ${conn.id === activeConnectionId ? 'cd-saved-item--active' : ''}`}
                    >
                      <span className={`cd-status-dot ${conn.status === 'connected' ? 'cd-status-dot--on' : ''}`} />
                      <div>
                        <p className="cd-saved-name">{conn.name || conn.database}</p>
                        <p className="cd-saved-host">{conn.host} / {conn.database}</p>
                      </div>
                    </button>
                  ))}
                </div>
              ...
              <p className="cd-section-label">New Connection</p>
            ...
            <>
              ...
              {connectorType === 'cosmosdb' && (
                <div className="cd-form">
                  <div className="cd-field">
                    <label>Connection Name</label>
                    <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="My Cosmos DB" />
                  </div>
                  <div className="cd-field">
              ...
              {connectorType === 'mongodb' && (
                <div className="cd-form">
                  <div className="cd-field">
                    <label>Connection Name</label>
                    <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="My MongoDB" />
                  </div>
                  <div className="cd-field">
              ...
              {connectorType === 'powerbi' && (
                <div className="cd-form">
                  <div className="cd-field">
                    <label>Connection Name</label>
                    <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="My Power BI Dataset" />
                  </div>
                  <div className="cd-form-row cd-form-row--2">
                    <div className="cd-field">
                    ...
                    <div className="cd-field">
                      ...
                      <input type="text" value={clientId} onChange={(e) => setClientId(e.target.value)} placeholder="App (Service Principal) ID" />
                    </div>
                  </div>
                  <div className="cd-field">
                  ...
                  <div className="cd-form-row cd-form-row--2">
                    <div className="cd-field">
                      ...
                      <input type="text" value={pbiWorkspaceId} onChange={(e) => setPbiWorkspaceId(e.target.value)} placeholder="Power BI workspace/group ID" />
                    </div>
                    <div className="cd-field">
                      <label>Dataset ID</label>
                      <input type="text" value={datasetId} onChange={(e) => setDatasetId(e.target.value)} placeholder="Power BI dataset ID" />
                    </div>
                  </div>
                </div>
              )}
              ...
              {connectorType === 'file' && (
                <div className="cd-form">
                  <div className="cd-field">
                    <label>Connection Name</label>
                    <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="My Dataset" />
                  </div>
                  ...
                  <div className="cd-summary" style={{ width: '100%', textAlign: 'left' }}>
                    ...
                    {connectorType === 'powerbi' && (
                      <>
                        <div className="cd-summary-row">
                          <span className="cd-summary-label">Type</span>
                          <span className="cd-summary-value">Power BI</span>
                        </div>
                        <div className="cd-summary-row">
                          <span className="cd-summary-label">Workspace</span>
                          <span className="cd-summary-value" style={{ fontSize: 12, wordBreak: 'break-all' }}>{pbiWorkspaceId}</span>
                        </div>
                        <div className="cd-summary-row">
                          <span className="cd-summary-label">Dataset</span>
                          <span className="cd-summary-value" style={{ fontSize: 12, wordBreak: 'break-all' }}>{datasetId}</span>
                        </div>
                      </>
                    )}
        ...
        {step !== 'choose-type' && (
          <div className="cd-footer">
            ...
            {step === 'select-tables' && (
              ...
              >
                {isSubmitting ? (
                  <><Loader2 size={14} className="ts-spinner" /> Saving...</>
                ) : (
